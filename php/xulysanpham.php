<?php
    ...
    switch ($_POST['request']) {
        ...
        case 'add':
                ...
                $spAddArr = array(
                    ...
                    'DungTich' => $data['detail']['screen'],
                    'KhoiLuong' => $data['detail']['os'],
                    'PhuocTruoc' => $data['detail']['camara'],
                    'PhuocSau' => $data['detail']['camaraFront'],
                    'XYZ' => $data['detail']['cpu'],
                    'NhotMay' => $data['detail']['ram'],
                    'NhienLieu' => $data['detail']['rom'],
                    'Moment' => $data['detail']['microUSB'],
                    'Xylanh' => $data['detail']['battery'],
                    'SoSao' => $data['star'],
    ...
    function addFromWeb1() {
        ...
        $sanphamArr = array(
            ...
            'HinhAnh' => $sp['img'],
            'MaKM' => $sp['MaKM'],
            'DungTich' => $sp['detail']['screen'],
            'KhoiLuong' => $sp['detail']['os'],
            'PhuocTruoc' => $sp['detail']['camara'],
            'PhuocSau' => $sp['detail']['camaraFront'],
            'XYZ' => $sp['detail']['cpu'],
            'NhotMay' => $sp['detail']['ram'],
            'NhienLieu' => $sp['detail']['rom'],
            'Moment' => $sp['detail']['microUSB'],
            'Xylanh' => $sp['detail']['battery'],
            'SoSao' => 0,
            'SoDanhGia' => 0,
            'TrangThai' => 1
        ); 
